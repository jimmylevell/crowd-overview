...
import { getCheckpoints, updateCheckpoint, createCheckpoint, deleteCheckpoint } from '../services/checkpoint_service';
    ...
    <Layout>
      ...
      <div className="row">
        <div className="col-sm-4">
          <button type="button" className="btn btn-primary mb-3" data-bs-toggle="modal" data-bs-target="#checkpointeditor">
        ...
        <div className="col-sm-8">
          <Graph data={"dinetwork {node[shape=circle]; 1 -> 1 -> 2; 2 -> 3; 2 -- 4; 2 -> 1 }"} />
        </div>
      </div>
    </Layout>
  )
