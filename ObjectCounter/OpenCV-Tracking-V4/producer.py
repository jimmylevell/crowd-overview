...
def run(
    ...
    nms_max_overlap = (
        settings.nms_max_overlap
    )  # non-maxima suppression, i.e. removes all boxes with a lower score than the max box
    model_filename = (
        ...
        with tf.Session() as sess:
            ...
            while True:
                ...
                for track in tracker.tracks:
                    ...
                    color = colors[
                        int(track.get_class()) % len(colors)
                    ...
                    for j in range(1, len(pts[track.track_id])):
                        ...
                        if (
                            ...
                            or pts[track.track_id][j - 1] is None
                        ):
                            continue
